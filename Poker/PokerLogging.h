...
#ifndef __POKERLOGGING_H__
#define __POKERLOGGING_H__
...
template <typename type > bool LogRound( type & log, const Round & theRound )
{
...
template <typename type > bool LogHoleCards( type & log , const Round & theRound )
{
...
template <typename type > bool LogBoard( type & log, const Cards * theBoard, const HoldemStages stage )
{
